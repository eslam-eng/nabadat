		...
		<nav class="sidebar-main">
			...
			<div id="sidebar-menu">
				<ul class="sidebar-links" id="simple-bar">
					...
					<li class="sidebar-list">
						<label class="badge badge-success">2</label><a class="sidebar-link sidebar-title <?php echo e(request()->route()->getPrefix() == 'addCountry' ? 'active' : ''); ?>" href="#"><i data-feather="home"></i><span class="lan-3"><?php echo e(trans('lang.Locations')); ?></span>
...
<?php /**PATH C:\xampp\htdocs\Nabadat\resources\views/layouts/simple/sidebar.blade.php ENDPATH**/ ?>