...
<h3><?php echo e(trans('lang.CITY_LIST')); ?></h3>
<?php $__env->stopSection(); ?>
		...
		<div class="col-sm-12">
			<div class="card">
                <div class="card-header">
					<a href="<?php echo e(route('create.city')); ?>"> <?php echo e(trans('lang.ADD_NEW_CITY')); ?></a>
				</div>
				<div class="card-header">
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Nabadat\resources\views/locations/city/index.blade.php ENDPATH**/ ?>