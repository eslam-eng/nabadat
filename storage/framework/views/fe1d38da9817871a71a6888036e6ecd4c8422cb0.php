                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-primary btn-xs" >
                                        <a href="<?php echo e(route('edit.country',['id' => $country->id])); ?>" ></a>
                                    ...
                                    <form class="delete_form" id="myformarticle<?php echo e($country->id); ?>"  action="<?php echo e(route('delete.country',['id' => $country->id])); ?>" method="post">
                                        ...
                                        <button type="submit" class="delete_btnn label label-danger" name="Delete"><i class="fa fa-trash"></i></button>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /code/Nabadat/resources/views/locations/country/list.blade.php ENDPATH**/ ?>