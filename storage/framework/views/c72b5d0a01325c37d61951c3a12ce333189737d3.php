				...
				<div class="card-body">
					<form class="needs-validation" novalidate="" method="POST" action="/store/governate" >
						...
						<div class="row">
                            ...
                            <div class="mb-2">
                                <div class="col-form-label">Choose Governate</div>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /code/Nabadat/resources/views/countries/city/form.blade.php ENDPATH**/ ?>