            ...
            <div class="card">
               <div class="card-body">
                  <div class="product-page-details">
                     <h3><?php echo e($governorate->slug); ?></h3>
                  </div>
                  ...
                  <div>
                     <table class="product-page-width">
                        <tbody>
                           <tr>
                              <td> <b>Slug &nbsp;&nbsp;&nbsp;:</b></td>
                              <td><?php echo e($governorate->slug); ?></td>
                           </tr>
                           <tr>
                              <td> <b>Title &nbsp;&nbsp;&nbsp;: &nbsp;&nbsp;&nbsp;</b></td>
                              <td class="txt-success"><?php echo e($governorate->title); ?></td>
                           </tr>
                           <tr>
                              <td> <b>ISO-Code-2 &nbsp;&nbsp;&nbsp;: &nbsp;&nbsp;&nbsp;</b></td>
                              <td><?php echo e($governorate->iso_code_2); ?></td>
                           </tr>
                        </tbody>
                     </table>
                  </div>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /code/Nabadat/resources/views/locations/governorate/show.blade.php ENDPATH**/ ?>