					...
					<form class="needs-validation" novalidate="" method="POST" action="{{route('update.governorate',['id' => $governorate->id])}}" >
						...
						<div class="row">
                            ...
                            <div class="col-md-6 mb-3">
								...
								<input name="title_en" value="{{$governorate->title_translations['en']}}" class="form-control" id="validationCustom02" type="text" placeholder="{{__('TITLE')}}" required="">
								<div class="valid-feedback">Looks good!</div>
							</div>
                            <div class="col-md-6 mb-3">
								<label for="validationCustom02"> {{__("ARABIC_TITLE")}}</label>
								<input name="title_ar" value="{{$governorate->title_translations['ar']}}" class="form-control" id="validationCustom02" type="text" placeholder="{{__('ARABIC_TITLE')}}" required="">
								<div class="valid-feedback">Looks good!</div>
							</div>
                            <div class="mb-2">
                                <div class="col-form-label">Choose Country</div>
                                <select name="parent_id" value={{$governorate->title}} class="js-example-placeholder-multiple col-sm-12" multiple="multiple">
